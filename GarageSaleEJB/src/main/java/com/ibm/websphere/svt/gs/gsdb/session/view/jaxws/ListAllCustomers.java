...
@XmlRootElement(name = "listAllCustomers", namespace = "http://view.session.gsdb.gs.svt.websphere.ibm.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listAllCustomers", namespace = "http://view.session.gsdb.gs.svt.websphere.ibm.com/")
