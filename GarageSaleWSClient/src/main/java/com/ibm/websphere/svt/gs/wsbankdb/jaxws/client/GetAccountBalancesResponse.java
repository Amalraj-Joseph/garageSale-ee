 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://jaxb.dev.java.net/array}floatArray" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "getAccountBalancesResponse", propOrder = {
    "_return"
})
public class GetAccountBalancesResponse {

    @XmlElement(name = "return", nillable = true)
    protected List<FloatArray> _return;
     ...
     * 
     */
    public List<FloatArray> getReturn() {
        if (_return == null) {
            _return = new ArrayList<FloatArray>();
        }
        return this._return;
    }
