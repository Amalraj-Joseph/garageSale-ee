 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://view.session.gsdb.gs.svt.websphere.ibm.com/}categoryWrapper" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ListCategoriesResponse {
    ...
    protected List<CategoryWrapper> _return;
     ...
     * 
     */
    public List<CategoryWrapper> getReturn() {
        if (_return == null) {
            _return = new ArrayList<CategoryWrapper>();
        }
        return this._return;
    }
