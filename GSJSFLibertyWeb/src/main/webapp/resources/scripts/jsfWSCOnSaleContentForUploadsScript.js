		...
		function printHidden(){
			var hiddenValue=document.getElementById('onSaleContentForm:jsfWSCOnSaleContentForUploadsID').value;
		...
		function printTable(jsonArray) {
	       ...
	       window.onload= function() { 
		        document.getElementById('onSaleContentForm:onSaleContentForUploadsButtonID').click();
		   }
