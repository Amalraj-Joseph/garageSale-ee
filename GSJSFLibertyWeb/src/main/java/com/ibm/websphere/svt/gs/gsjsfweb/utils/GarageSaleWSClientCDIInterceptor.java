 ...
 *
 */
@GarageSaleWSClientCDIInterceptorBinding
@Interceptor
@Priority(Interceptor.Priority.APPLICATION)
public class GarageSaleWSClientCDIInterceptor {
	
	private static String componentName = "com.ibm.websphere.svt.gs.gsjsfweb.utils";
	private static Logger logger = Logger.getLogger(componentName);
	private static String className = GarageSaleWSClientCDIInterceptor.class.getName();
	...
	public GarageSaleWSClientCDIInterceptor(){
	}
