...
public class ExceptionHandlerImpl extends ExceptionHandler
{
    ...
    private static final Logger log = Logger.getLogger(componentName);
	private static final String CLASS_NAME = ExceptionHandlerImpl.class.getName();
    ...
    public void handle() throws FacesException
    {
        ...
        if (unhandled != null && !unhandled.isEmpty())
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    if (!shouldSkip(exception))
                    {
                        ...
                        log.finer("ExceptionQueuedEvent " + handledAndThrown.toString());
    				...
    				log.logp(Level.SEVERE, CLASS_NAME, methodName, "Severe Error is "+exception.getMessage());
            ...
            if (toThrow != null)
            {
            	log.exiting(CLASS_NAME, methodName, toThrow);
                throw toThrow;
            }
        }
