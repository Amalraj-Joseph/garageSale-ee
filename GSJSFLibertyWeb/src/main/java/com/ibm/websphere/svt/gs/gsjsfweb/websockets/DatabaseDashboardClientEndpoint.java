...
@ClientEndpoint
public class DatabaseDashboardClientEndpoint {
    
	private static String componentName = "com.ibm.websphere.svt.gs.gsjsfweb.websockets";
	private static Logger logger = Logger.getLogger(componentName);
	private static String className = DatabaseDashboardClientEndpoint.class.getName();
	private static final String DASHBOARD_MAP_KEY= DatabaseDashboardClientEndpoint.class.getSimpleName();
	...
	public void onMessage(Session session, String message) {
    	...
    	if(message !=null){
        	try {
        		WebSocketsDataBean.setDatabaseDashboardData(message);
