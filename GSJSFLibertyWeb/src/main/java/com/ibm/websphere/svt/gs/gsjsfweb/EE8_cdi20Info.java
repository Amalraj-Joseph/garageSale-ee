...
@ManagedBean(name="ee8_cdi20Info")
@ViewScoped
public class EE8_cdi20Info implements java.io.Serializable {
	...
	private static String className = EE8_cdi20Info.class.getName();
	
	public String gotoee8_cdi20Info() {
		String methodName = "gotoee8_cdi20Info";
