...
@ClientEndpoint
public class WebSocketsDashboardClientEndpoint {
    
	private static String componentName = "com.ibm.websphere.svt.gs.gsjsfweb.websockets";
	private static Logger logger = Logger.getLogger(componentName);
	private static String className = WebSocketsDashboardClientEndpoint.class.getName();
	private static final String DASHBOARD_MAP_KEY= WebSocketsDashboardClientEndpoint.class.getSimpleName();
	...
	public void onMessage(Session session, String message) {
    	...
    	if(message !=null){
        	try {
        		WebSocketsDataBean.setWebSocketsDashboardData(message);
        		if(session!=null){
