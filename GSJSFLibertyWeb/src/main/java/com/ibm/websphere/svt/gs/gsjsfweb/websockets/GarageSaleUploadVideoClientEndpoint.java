...
@ClientEndpoint
public class GarageSaleUploadVideoClientEndpoint {
    
	private static String componentName = "com.ibm.websphere.svt.gs.gsjsfweb.websockets";
	private static Logger logger = Logger.getLogger(componentName);
	private static String className = GarageSaleUploadVideoClientEndpoint.class.getName();
	private static final String DASHBOARD_MAP_KEY= GarageSaleUploadVideoClientEndpoint.class.getSimpleName();
