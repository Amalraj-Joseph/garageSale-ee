...
@XmlRootElement(name = "validateCardResponse", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "validateCardResponse", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
