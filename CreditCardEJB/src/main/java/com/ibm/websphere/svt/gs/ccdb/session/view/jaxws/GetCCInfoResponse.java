...
@XmlRootElement(name = "getCCInfoResponse", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getCCInfoResponse", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
