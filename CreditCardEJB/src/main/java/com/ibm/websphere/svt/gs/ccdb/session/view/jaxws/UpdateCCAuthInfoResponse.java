...
@XmlRootElement(name = "updateCCAuthInfoResponse", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateCCAuthInfoResponse", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
