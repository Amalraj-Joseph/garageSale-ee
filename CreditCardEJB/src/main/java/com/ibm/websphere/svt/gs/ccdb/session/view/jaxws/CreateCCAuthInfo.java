...
@XmlRootElement(name = "createCCAuthInfo", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createCCAuthInfo", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
