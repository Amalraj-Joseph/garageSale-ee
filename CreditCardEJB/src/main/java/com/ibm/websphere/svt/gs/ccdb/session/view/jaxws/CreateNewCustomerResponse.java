...
@XmlRootElement(name = "createNewCustomerResponse", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createNewCustomerResponse", namespace = "http://view.session.ccdb.gs.svt.websphere.ibm.com/")
